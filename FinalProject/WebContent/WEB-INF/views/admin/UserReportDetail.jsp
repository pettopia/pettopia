		...
		<div style="margin-bottom: 70px;">
			...
			<div style="float: right;">
				<ul class="list-inline">
					...
					<li class="list-inline-item"><a href="javascript:void(0)" class="btn btn-default disapproval" role="button">제재불가</a></li>
				</ul>
			</div>
			...
			<form action="usreportreg.action" method="post" id="approval">
			...
			<form action="usreportref.action" method="post" id="disapproval">
				<input type="hidden" name="code" value="${report.code }">
