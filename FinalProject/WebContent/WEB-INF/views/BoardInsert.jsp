			...
			<div class="div_inner">
				<div class="contents_wrap">
					...
					<div id="textEditorFrame">
						<form id="frmCreate" method="post" action="boardinsert.action">
							...
							<div class="title_wrap form-inline">
								...
								style="margin-left:27px; margin-top:13px; width: 730px;">
							</div><!-- .title_wrap end -->
							...
							<div class="write_form_wrap"> 
								<div class="editor_sec">
									<div class="edSec">
					                    <div class="edWSec">
					                        <textarea class="editWindow" name="content" id="content" rows="9" cols="40"></textarea>
					                    </div>
									</div><!-- .edSec end -->									
