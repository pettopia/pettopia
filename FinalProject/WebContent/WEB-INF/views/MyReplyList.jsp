...
<div id="wrapper">
	...
	<div class="main_content" style="margin-left: 240px; padding-top: 60px;">
		...
		<div class="header">
			<span style="font-weight:bold; font-size: 20pt;">내가 쓴 댓글</span>
		</div>
		...
		<div class="comment_list">
			...
			<table class="table" style="width: 910px;">
				...
				<tr>
					...
					<th style="border: none; width: 400px;">게시글제목</th>
					<th style="border: none;">댓글내용</th>
					<th style="border: none;">닉네임</th>
					<th style="border: none;">댓글작성일</th>
				...
				<tbody>
					...
					<c:forEach var="dto" items="${list }">
						<tr>
							...
							<td id="title">&nbsp;<span style="color:red;">[${dto.head}]</span>&nbsp;${dto.title }&nbsp;</td>
							<td>${dto.content}</td>
							<td>${dto.nick }</td>
							<td>${dto.reg_date }</td>
