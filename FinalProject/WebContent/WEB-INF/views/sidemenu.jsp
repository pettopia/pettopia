...
$(function () {
    ...
    $("#psmypage").click(function()
    {
    	$(location).attr('href','mypage_ps.action');
    });
...
<script type="text/javascript">
   $(document).ready(function()
   {
      ...
      $(".psmypage").click(function()
       {
          $(location).attr('href','petsitterview2.action');
...
<div class="sidebar">
	    ...
	    <li data-extension="close">
	        <div class="main-title"><a>산책관리</a><span class="folder"> </span></div>
	        <ul class="sub">
	            <li><a href="meeting_review.jsp">리뷰 내역</a></li>
	        </ul>
	    </li>
	
	    <li data-extension="close">
	        <div class="main-title"><a>돌봄관리</a><span class="folder"> </span></div>
	        <ul class="sub">
	            <li><a href="mycarelist.action">돌봄신청 내역</a></li>
	            <li><a href="myreflist.action">환불신청 내역</a></li>
	            <li><a href="mycarereview.action">리뷰 내역</a></li>
	        </ul>
	    </li>
	    <li data-extension="close">
	        <div class="main-title"><a>나의게시물</a><span class="folder"> </span> </div>
	        <ul class="sub">
	            <li><a href="myboardlist.action">내가쓴 게시물</a></li>
	            <li><a href="myreplylist.action">내가쓴 댓글</a></li>
	        </ul>
	    </li>
	   <li data-extension="close">
	        <div class="main-title"><a>내정보관리</a><span class="folder"> </span> </div>
	        <ul class="sub">
	            <li><a href="checkpwform.action?n=1">내정보 수정</a></li>
	            <li><a href="checkpwform.action?n=2">비밀번호 변경</a></li>
