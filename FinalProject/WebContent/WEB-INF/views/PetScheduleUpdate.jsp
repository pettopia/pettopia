...
<body>
   ...
   <form action="petdiaryupdate.action" method="post" class="input form-inline" role="form" id="form">
      ...
      <!-- <form class="input form-inline" role="form"> -->
         ...
         <br> 일시 : 
             <input type="text" class="form-control" style="width:100px;" name="startdate" id="startdate" value="${startdate }">
             <input type="text" class="form-control" style="width:100px;" name="startdate" id="startdatetime" 
             readonly="readonly" placeholder="시간을 입력하세요" value="${startdatetime }">
            &nbsp;-&nbsp;
            <input type="text" class="form-control" style="width:100px;" name="enddate" id="enddate" value="${enddate }">
            <input type="text" class="form-control" style="width:100px;" name="enddate" id="enddatetime" 
            readonly="readonly" placeholder="시간을 입력하세요" value="${enddatetime }">
